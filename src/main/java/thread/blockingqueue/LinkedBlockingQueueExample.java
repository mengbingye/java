...
public class LinkedBlockingQueueExample {
    ...
    static class ProviderThread extends Thread {
        ...
        public void run() {
            ...
            // 本线程处理完毕的标记
            LinkedBlockingQueueExample.providerDoneFlag[threadNo] = true;
    ...
    static class ConsumerThread implements Runnable {
        ...
        public void run() {
            ...
            while (LinkedBlockingQueueExample.getDone() == false || linkedBlockingQeque.isEmpty() == false) {
    ...
    public static synchronized void setDone(boolean flag) {
        LinkedBlockingQueueExample.done = flag;
    }

    public static synchronized boolean getDone() {
        return LinkedBlockingQueueExample.done;
    }
    ...
    public static void main(String[] args) {
        ...
        do {
            for (boolean b : providerDoneFlag) {
                ...
                LinkedBlockingQueueExample.setDone(true);
            }

            // 生产者线程全部结束的时候，跳出检测
            if (LinkedBlockingQueueExample.getDone() == true) {
                break;
            }
        } while (true);
